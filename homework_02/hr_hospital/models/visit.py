...
class Visit(models.Model):
    ...
    doctor_id = fields.Many2one('res.users', string='Doctor', required=True, domain="[('is_doctor', '=', True)]")
    disease_id = fields.Many2one('hr_hospital.disease', string='Main Disease')
    disease_ids = fields.Many2many('hr_hospital.disease', string='Other Diseases')
